...
define(['app', 'backbone','underscore','helper','preloader'], function (app, Backbone, _, helper, preloader) {
    ...
    var ProjectView = Backbone.View.extend({
        template:_.template('<div class="visible item-block <% _.each(fields, function (tag){ tag = %><%= tag%> <%})%>" id="work_<%= id %>">'+
                            ...
                            '<img src="data:image/gif;base64,R0lGODlhAQABAIAAAP//////zCH5BAEHAAAALAAAAAABAAEAAAICRAEAOw==" data-echo="<%= covers["404"] %>">'+
                            '</span>'+
                            '<span class="back">'+
                            '<span class="desc">'+
