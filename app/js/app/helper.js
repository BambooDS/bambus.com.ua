...
define(['modernizr-custom'], function (Modernizr) {
    'use strict';
...
**/
    ...
    var ColorConverter = {
        hexToRGB : function  (h) {
            return new RGB(parseInt((cutHex(h)).substring(0,2),16), parseInt((cutHex(h)).substring(2,4),16), parseInt((cutHex(h)).substring(4,6), 16));
        },
